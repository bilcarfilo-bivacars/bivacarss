...
@section('title', 'Partner Leadler')

@section('content')
<div class="container py-4">
    <h1 class="h4 mb-3">Partner Leadler</h1>
    ...
    <table class="table table-striped">
        <thead><tr><th>ID</th><th>Ad</th><th>Skor</th><th>Grade</th><th>Status</th><th></th></tr></thead>
        <tbody>
        @foreach($leads as $lead)
            <tr>
                ...
                <td><a href="{{ route('admin.partner-leads.show', $lead->id) }}" class="btn btn-sm btn-outline-dark">Detay</a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
